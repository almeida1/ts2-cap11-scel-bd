...
class REQ021CadastrarLivroTests {
	...
	Livro livro = new Livro("4444", "User Stories", "Cohn"); HttpEntity<Livro> httpEntity = new HttpEntity<>(livro);
	ResponseEntity<String> resposta = testRestTemplate.exchange(urlBase, HttpMethod.POST, httpEntity, String.class);
	...
	assertEquals("400 BAD_REQUEST", resposta.getStatusCode().toString()); assertEquals("Livro já cadastrado",resposta.getBody());
	}
	@Test
